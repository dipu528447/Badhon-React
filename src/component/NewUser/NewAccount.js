                        ...
                        <div className="card-body">
                            ...
                            <form>
                                ...
                                <div className="mb-3 row">
                                    ...
                                    <div className="col-sm-8">
                                        <input type="email" required className="form-control" id="staticEmail"/>
                                    </div>
                                </div>
                                <div className="mb-3 row">
                                ...
                                <div className="mb-3 row d-flex justify-content-center">
                                    <div className="col-sm-5">
                                        <Link to="/"><button type="submit" onClick={signin}id="btn-submit" className='btn btn-primary'>Sign Up</button></Link>
                                    </div>
                                </div>
                            </form>
                        </div>
